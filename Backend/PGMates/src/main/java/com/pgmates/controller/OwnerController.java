...
public class OwnerController {
	...
	@GetMapping("/getBookedAppointments/{ownerId}")
	public ResponseEntity<?> getBookedAppointments(@PathVariable int ownerId){
		List<BookedAppointmentsDto> list = ownerService.getBookedAppointmentsByOwnerId(ownerId);
		return ResponseEntity.status(HttpStatus.OK).body(list);
	}
	
	@PutMapping("toggleAvailability/{propertyId}")
	public ResponseEntity<?> toggleAvailability(@PathVariable int propertyId) {
		//TODO: process PUT request
		return ResponseEntity.status(HttpStatus.OK).body(ownerService.togglePropertyAvailability(propertyId));
