...
public class AuthService {
	...
	public ApiResponse registerUser(UserDto userDTO) {
		...
		try {
		    String msg = "Welcome "+user.getFirstName()+"!"+"<br>Thank You for registering with pgmates!<br>Regards, <br>Team Pgmates"; 
		    
		    emailService.sendEmail(user.getEmail(), "Registration Successful 🥳", msg);
