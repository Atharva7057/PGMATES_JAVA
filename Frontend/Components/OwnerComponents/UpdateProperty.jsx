...
function RegisterProperty() {
    ...
    const fetchDetails =  async () => {
        try{
            propertyresponse = await ownerServices.getPropertyDetails(pid); 
            console.log("property response",propertyresponse);
            
            setFormData({
                rent: propertyresponse.rent || "",
                deposit: propertyresponse.deposit || "",
                propertyType: propertyresponse.type || "",
                furnishedType: propertyresponse.furnishType || "",
                location: propertyresponse.location || "",
                addressLine1: propertyresponse.address?.addressLine1 || "",
                addressLine2: propertyresponse.address?.addressLine2 || "",
                city: propertyresponse.address?.city || "",
                state: propertyresponse.address?.state || "",
                pincode: propertyresponse.address?.pincode || "",
                nearbyPlaces: propertyresponse.nearByPlaces || "",
                amenities: propertyresponse.amenities || "",
                description: propertyresponse.description || "",
                capacity: propertyresponse.capacity || "",
                gender: propertyresponse.forGender || "",
                owner: propertyresponse.owner || 0,
                image: propertyresponse.image || null,
            });
    ...
    const handleSubmit = async (e) => {
        ...
        if (Object.keys(errors).length === 0) {
            ...
            const response = await OwnerServices.updateProperty(pid,formData);
        ...
        <>
            ...
            >
                <div className="w-100" style={{ maxWidth: "600px" }}>
                    <h1 className="text-center mb-4">Update Property Details</h1>
