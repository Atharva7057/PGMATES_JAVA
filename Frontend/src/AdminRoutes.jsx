...
import ViewPropertyDetails from '../Components/AdminComponents/ViewPropertyDetails.jsx';
  ...
  return (
    <Routes>
      ...
      <Route element={<AdminLayout />}>
        ...
        <Route path="property-details" element={isAdmin ? <ViewPropertyDetails /> : <AccessDenied />} />
      </Route>
